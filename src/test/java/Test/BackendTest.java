...
public class BackendTest {
    ...
    String urlBase = "https://parabank.parasoft.com/parabank/register.htm";
    String customerId = "15431";
    String accountId = "17562";
    String username = "Delfina";
    String password = "Delfina";
